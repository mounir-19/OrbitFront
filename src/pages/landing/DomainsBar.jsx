const domains = [
  {
    name: 'Design',
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 19l7-7 3 3-7 7-3-3z" /><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z" /><path d="M2 2l7.586 7.586" /><circle cx="11" cy="11" r="2" /></svg>,
  },
  {
    name: 'Web Dev',
  ...
  {
    name: 'Architecture',
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 21h18" /><path d="M5 21V7l8-4v18" /><path d="M19 21V11l-6-4" /><line x1="9" y1="9" x2="9" y2="9.01" /><line x1="9" y1="13" x2="9" y2="13.01" /><line x1="9" y1="17" x2="9" y2="17.01" /></svg>,
  },
  {
    name: 'Commerce',
  ...
  {
    name: 'Presentation',
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" /><path d="M8 21h8" /><path d="M12 17v4" /></svg>,
  },
  {
    name: 'Voice Over',
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z" /><path d="M19 10v2a7 7 0 0 1-14 0v-2" /><line x1="12" y1="19" x2="12" y2="23" /><line x1="8" y1="23" x2="16" y2="23" /></svg>,
  },
  {
    name: 'Social Media',
  ...
  return (
    <section
      ...
      style={{
        ...
        borderBottom: '1px solid rgba(100,80,180,0.12)',
      }}
    >
      {/* Fade edges */}
      <div className="absolute left-0 top-0 bottom-0 w-20 z-10 pointer-events-none"
        style={{ background: 'linear-gradient(to right, #0f0f24, transparent)' }} />
      <div className="absolute right-0 top-0 bottom-0 w-20 z-10 pointer-events-none"
        style={{ background: 'linear-gradient(to left, #0f0f24, transparent)' }} />

      {/* Scrolling track */}
      <div
        className="flex whitespace-nowrap w-max"
        style={{ animation: 'scroll-domains 25s linear infinite' }}
      ...
      >
        {doubled.map((d, i) => (
          <div
            key={i}
            className="inline-flex items-center gap-3 px-10 py-5 text-[0.95rem] font-semibold text-white/60 tracking-[0.5px] cursor-default transition-colors hover:text-violet-400 group"
            style={{ borderRight: '1px solid rgba(100,80,180,0.12)' }}
          >
